function calker_cal_map(proj_name, exp_name, ker, events, videolevel, fusion)
	...
	scorePath = sprintf('%s/scores/%s/%s.%s.scores.mat', calker_exp_dir, ker.test_pat, ker.name, ker.type);
	videoScorePath = sprintf('%s/scores/%s/%s.video.scores.mat', calker_exp_dir, ker.test_pat, ker.name);
	mapPath = sprintf('%s/scores/%s/%s.%s.map.csv', calker_exp_dir, ker.test_pat, ker.name, ker.type);
